...
- (void)close
{
    ...
    [self performSelectorOnMainThread:@selector(viewAnimationHide)
                           withObject:nil
                        waitUntilDone:NO];
}
...
- (void)cancel {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:SHKOAuth2ViewDidCloseNotification
                                                        object:nil];
}
